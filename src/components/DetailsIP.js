...
const DetailsIP = ({ ipAddress, location, timezone, isp}) => {
  return (
    <div 
    className='bg-white w-4/5 h-auto rounded-xl shadow-lg p-4 mt-32 lg:mt-48 md:mt-48 md:px-10, mt lg:px-8 absolute z-10 flex flex-col justify-between items-center lg:items-start md:items-start lg:flex-row md:flex-row md:h-32 lg:h-32'>
